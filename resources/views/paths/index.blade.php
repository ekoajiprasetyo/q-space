            ...
            <div class="bg-white/80 backdrop-blur-xl rounded-[2.5rem] border border-white/50 shadow-sm overflow-hidden">
                ...
                @else
                    <div class="overflow-x-auto">
                        <table class="w-full table-fixed border-collapse text-left" style="min-width: 1060px">
                            <colgroup>
                                <col class="w-40">
                                <col class="w-80">
                                <col>
                            ...
                            <thead>
                                <tr class="border-b border-slate-100 text-slate-400 text-xs uppercase tracking-wider font-bold">
                                    <th class="px-6 py-6">Nama Link</th>
                                    <th class="px-6 py-6">Short Link</th>
                                    <th class="px-6 py-6">URL Asli</th>
                                    <th class="px-6 py-6 text-center">Kunjungan</th>
                                    <th class="px-6 py-6">Dibuat</th>
                                        ...
                                        <td class="px-6 py-5">
                                            <div class="flex items-center justify-end gap-2 whitespace-nowrap">
                                                <button @click="openEditModal('{{ route('paths.update', $link) }}', '{{ $link->original_url }}', '{{ $link->short_code }}')"
                                                    class="w-9 h-9 rounded-full bg-blue-50 text-blue-500 hover:bg-blue-500 hover:text-white flex items-center justify-center transition-all duration-300" title="Edit Path">
